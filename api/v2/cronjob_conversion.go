...
import (
	...
	"github.com/chanshik/cronjob/api/v1"
)
...
func (dst *CronJob) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if len(schedParts) != 5 {
		return fmt.Errorf("invalid shcedule: not a standard 5-field schedule")
	}
	...
	dst.Spec.Schedule.DayOfMonth = partIfNeeded(schedParts[4])
