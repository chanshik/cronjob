...
import (
	...
	cronjobv1 "github.com/chanshik/cronjob/api/v1"
)
		...
		It("Should increase CronJob Status.Active count when new Jobs are created", func() {
			...
			cronJob := &cronjobv1.CronJob{
				TypeMeta: metav1.TypeMeta{
					APIVersion: "batch.tutorial.chanshik.dev/v1",
					Kind:       "CronJob",
				},
			...
			Eventually(func() ([]string, error) {
				...
				"should list our active job %s in the active jobs list in status", JobName)
		})
	})
})
